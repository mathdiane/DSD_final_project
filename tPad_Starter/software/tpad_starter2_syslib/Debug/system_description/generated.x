 ...
 *
 * Generated: 2015-12-16 17:57:50.054
 *
 */
...
MEMORY
{
    reset : ORIGIN = 0x0a800000, LENGTH = 32
    onchip_mem_UNUSED : ORIGIN = 0x0b040000, LENGTH = 32
    onchip_mem : ORIGIN = 0x0b040020, LENGTH = 262112
    sdram : ORIGIN = 0x00000000, LENGTH = 134217728
    cfi_flash : ORIGIN = 0x0a800020, LENGTH = 8388576
}

    /* Define symbols for each memory base-address */
 __alt_mem_onchip_mem = 0x0b040000 ;
 __alt_mem_sdram = 0x00000000 ;
 __alt_mem_cfi_flash = 0x0a800000 ;
...
SECTIONS
{
    ...
    .text :
    {
        ...
        *(.dynamic)
        ...
        KEEP (*(.jcr))
        . = ALIGN(32 / 8);
    } >  onchip_mem =0x3a880100 /* NOP on Nios2 (big endian) */
...
PROVIDE( __alt_heap_limit    = 0x08000000 );
